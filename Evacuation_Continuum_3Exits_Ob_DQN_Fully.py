...
output_dir = output_dir + '/Continuum_3Exits_Ob_DQN_Fully'
model_saved_path = model_saved_path + '/Continuum_3Exits_Ob_DQN_Fully'    
name_mainQN = 'main_qn_3exits_ob'    
name_targetQN = 'target_qn_3exits_ob'
